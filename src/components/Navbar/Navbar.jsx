...
// ⚡ Bolt: Extract static array mappings to module scope
// This prevents recalculating string replacements and array maps on every scroll event render
const NAV_ITEMS = navLinks.map(link => ({
  ...link,
  id: link.href.replace('#', '')
}));
const SECTION_IDS = NAV_ITEMS.map(link => link.id);
