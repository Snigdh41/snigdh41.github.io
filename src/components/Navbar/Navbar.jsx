...
// Pre-calculate derived static values outside component to avoid recalculation on render
const navLinksWithIds = navLinks.map((link) => ({
  ...link,
  id: link.href.replace('#', ''),
}));
const sectionIds = navLinksWithIds.map((link) => link.id);
