...
export default function Contact() {
  ...
  const ctaRef = useScrollReveal({ duration: 700, delay: 300 });
    ...
    <section className={`section ${styles.contact}`} id="contact">
      <div className="container">
        ...
        <p className={styles.subtitle}>
          Have a project in mind or want to chat? Feel free to reach out — I&apos;m always open to new opportunities and conversations.
        </p>
        ...
        <div className={styles.ctaBlock} ref={ctaRef}>
          <p className={styles.ctaText}>Prefer a quick email?</p>
          <a
            href="mailto:contact@snigdhsharma.in"
