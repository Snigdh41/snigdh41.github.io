...
## 2026-06-25 - Concurrent External Requests
**Learning:** Sequential HTTP requests cause accumulated latency in Cloudflare Workers.
**Action:** Use Promise.all() for independent external API calls like Resend to prevent accumulated latency.
