...
## 2026-05-14 - Static Array Mappings Outside Component
**Learning:** Performing array manipulations (e.g., mapping and string replacement) inside a React component for static data causes unnecessary recalculation on every render.
**Action:** Extract static array mappings and derivations into the module scope outside of the React component definition to initialize them only once.
