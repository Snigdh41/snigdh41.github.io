...
## 2023-10-25 - [Concurrent External API Calls]
**Learning:** When making external HTTP requests in Cloudflare Workers (like invoking the Resend API), sequential execution adds unnecessary latency.
