...
const worker = {
  async fetch(request, env) {
    ...
    try {
      ...
      // ⚡ Bolt: Use Promise.all to execute independent external network requests concurrently
      // This prevents accumulated latency and significantly reduces overall execution time
