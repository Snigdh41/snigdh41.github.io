...
const worker = {
  async fetch(request, env) {
    ...
    try {
      ...
      // ⚡ Bolt: Send notification and auto-reply concurrently via Promise.all
      // This prevents the second request from waiting on the first, significantly reducing response latency
