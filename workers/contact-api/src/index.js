...
const worker = {
  async fetch(request, env) {
    ...
    try {
      ...
      // ⚡ Bolt: Batch into a single Promise.all instead of sequential await
      // This reduces backend execution latency significantly by sending emails concurrently
      console.log('[contact] Dispatching notification and auto-reply emails concurrently...');
