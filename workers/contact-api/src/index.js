...
const worker = {
  async fetch(request, env) {
    ...
    try {
      ...
      // ⚡ Bolt Optimization: Use Promise.all to execute independent API calls concurrently, reducing total latency by ~50% (combining two sequential network requests into one concurrent batch).
