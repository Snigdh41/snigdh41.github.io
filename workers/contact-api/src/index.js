...
const worker = {
  async fetch(request, env) {
    ...
    try {
      ...
      // ⚡ Bolt: Execute independent external HTTP requests concurrently using Promise.all()
      // This prevents accumulated latency and significantly reduces overall worker execution time
