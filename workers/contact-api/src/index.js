...
const worker = {
  async fetch(request, env) {
    ...
    try {
      ...
      // ⚡ Bolt: Execute independent external API requests concurrently using Promise.all()
      // This prevents accumulated latency and reduces the worker's overall execution time
